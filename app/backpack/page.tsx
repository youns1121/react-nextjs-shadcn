                    ...
                    <div className="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
                        <div
                            ...
                            <div
                                ...
                                <h1 className="relative mb-4 text-3xl font-black leading-tight text-gray-900 sm:text-6xl xl:mb-8">놀러와요 우리지역</h1>
                                <p className="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20">우리나라 지방소멸 위기지역에 대해 알아볼까요?</p>
                                <Button>More</Button>
                            ...
                            <div className="relative z-50 flex flex-col items-end justify-center w-full h-full lg:w-1/2 ms:pl-10">
                                <div className="container relative left-0 w-full max-w-4xl lg:absolute xl:max-w-6xl lg:w-screen">
                                    <Image
                                        className="w-[717px] h-[911px]"
                                        src="https://img.stibee.com/48127_1680584150.jpg"
                                        alt=""
                                        width={720}
                                        height={915}
                                    />
                                ...
                                <div className="flex flex-col items-center justify-center max-w-2xl py-8 mx-auto xl:flex-row xl:max-w-full">
                                    <div className="w-full xl:w-1/2 xl:pr-8">
                                        <blockquote
                                            ...
                                            {/* <Image className="flex-shrink-0 object-cover w-24 h-24 mb-5 bg-gray-300 rounded-full md:mb-0"
                                                src="https://www.ntels.com/wp-content/uploads/2018/07/EV_infra-400x250.png"
                                                width={500}
                                                height={500}
                                                alt=""
                                            /> */}
